...
final class BookModelTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        defaultPageModels = [
            ...
            .song(title: "Welcome to Red Songbook", songId: SongId(sectionIndex: 0, songIndex: 0)),
            .section(title: "Sample Songs"),
            .song(title: "1: A Tisket A Tasket", songId: SongId(sectionIndex: 1, songIndex: 0)),
            .song(title: "2: Hickory Dickory Dock", songId: SongId(sectionIndex: 1, songIndex: 1)),
            .song(title: "3: The Farmer in the Dell", songId: SongId(sectionIndex: 1, songIndex: 2)),
            .song(title: "4: Hey Diddle Diddle", songId: SongId(sectionIndex: 1, songIndex: 3)),
            .song(title: "5: Humpty Dumpty", songId: SongId(sectionIndex: 1, songIndex: 4)),
            .song(title: "6: Hush, Little Baby", songId: SongId(sectionIndex: 1, songIndex: 5)),
            .song(title: "7: Jack and Jill", songId: SongId(sectionIndex: 1, songIndex: 6)),
            .song(title: "8: Jack Be Nimble", songId: SongId(sectionIndex: 1, songIndex: 7)),
            .song(title: "9: Little Bo Peep", songId: SongId(sectionIndex: 1, songIndex: 8)),
            .song(title: "10: Little Miss Muffet", songId: SongId(sectionIndex: 1, songIndex: 9)),
            .song(title: "11: London Bridge", songId: SongId(sectionIndex: 1, songIndex: 10)),
            .song(title: "12: Mary Had a Little Lamb", songId: SongId(sectionIndex: 1, songIndex: 11)),
            .song(title: "13: Oh My Darling, Clementine", songId: SongId(sectionIndex: 1, songIndex: 12)),
            .song(title: "14: Patty Cake", songId: SongId(sectionIndex: 1, songIndex: 13)),
            .song(title: "15: Pop Goes the Weasel", songId: SongId(sectionIndex: 1, songIndex: 14)),
            .song(title: "16: Ring Around the Rosie", songId: SongId(sectionIndex: 1, songIndex: 15)),
            .song(title: "17: Rock-a-bye Baby", songId: SongId(sectionIndex: 1, songIndex: 16)),
            .song(title: "18: Row, Row, Row Your Boat", songId: SongId(sectionIndex: 1, songIndex: 17)),
            .song(title: "19: Twinkle Twinkle Little Star", songId: SongId(sectionIndex: 1, songIndex: 18)),
        ]
    ...
    func testImportWithTunes() async {
        ...
        XCTAssertEqual(
            ...
            [
                ...
                .song(title: "1: First Audio Sample", songId: SongId(sectionIndex: 0, songIndex: 0)),
                .song(title: "2: Second Audio Sample", songId: SongId(sectionIndex: 0, songIndex: 1)),
